...
- (void)configureWithPlatformType:(SSDKPlatformType)type appInfo:(NSMutableDictionary *)appInfo {
    switch (type) {
        case SSDKPlatformTypeSinaWeibo:
            [appInfo SSDKSetupSinaWeiboByAppKey:@"1090468165"
                                      appSecret:@"687ad8061ce9eae5658655471fddd560"
                                    redirectUri:@"http://www.sharesdk.cn"
                                       authType:SSDKAuthTypeBoth];
            break;
        case SSDKPlatformTypeWechat:
            [appInfo SSDKSetupWeChatByAppId:@"wxbedeabba7f64d7ca"
                                  appSecret:@"e638b1125e1d409bb83e87a2923eca02"];
            break;
        case SSDKPlatformTypeQQ:
            [appInfo SSDKSetupQQByAppId:@"1106187095"
                                 appKey:@"SM5zgcFNHyTIaGda"
