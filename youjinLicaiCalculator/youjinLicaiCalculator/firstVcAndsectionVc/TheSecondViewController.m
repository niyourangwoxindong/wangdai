...
//    _threeArr = [[NSMutableArray alloc]initWithObjects:@"推荐网贷计算器给好友",@"给网贷计算器评分",@"当前版本号", nil];
    _threeArr = [[NSMutableArray alloc]initWithObjects:@"推荐网贷计算器给好友",@"当前版本号", nil];
...
//        NSMutableDictionary *customParams = [NSMutableDictionary dictionary];
        ...
        [manager shareInView:self.view text:@"不在年化面前犯糊涂！！！！！" image:[UIImage imageNamed:@"wangdai"] url:@"https://www.youjin360.com/mobile/page/loanManageMoney.html" title:@"快来下载网贷计算器" objid:nil];
